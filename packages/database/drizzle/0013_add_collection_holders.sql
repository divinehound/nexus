...
CREATE INDEX idx_collection_holders_collection ON collection_holders(collection_id);
CREATE INDEX idx_collection_holders_address ON collection_holders(address);
